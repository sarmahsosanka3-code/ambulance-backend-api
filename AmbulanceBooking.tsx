...
export default function AmbulanceBooking() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const whatsappNumber = "9395072164";
      const message = `Ambulance Booking Details:\nBooking ID: ${booking.booking_id}\nPatient Name: ${booking.patient_name}\nPatient Age: ${booking.patient_age || 'N/A'}\nGender: ${booking.patient_gender}\nPhone: ${booking.phone_number}\nAmbulance Type: ${booking.problem_type}\nDispatch Type: ${booking.dispatch_type}\nPickup Address: ${booking.pickup_address}\nDestination: ${booking.destination_address}\nNotes: ${booking.notes || 'N/A'}`;
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, patient_name: e.target.value })}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, patient_age: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                <Label>Gender</Label>
                <RadioGroup
                  ...
                  onValueChange={(value: string) => setFormData({ ...formData, patient_gender: value })}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value: string) => setFormData({ ...formData, dispatch_type: value })}
                  className="flex gap-4"
                >
                  <div className="flex items-center space-x-2">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, pickup_address: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, destination_address: e.target.value })}
